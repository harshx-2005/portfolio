...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-between pt-28 overflow-hidden bg-darkBg">
      {/* Background spotlights & gradients */}
      <div className="absolute top-[10%] left-[5%] w-[400px] h-[400px] glow-orb-primary rounded-full blur-[120px] pointer-events-none opacity-30 animate-pulse-slow" />
      <div className="absolute top-[30%] right-[5%] w-[450px] h-[450px] glow-orb-secondary rounded-full blur-[120px] pointer-events-none opacity-30 animate-pulse-slow" />
      <div className="absolute bottom-[20%] left-1/3 w-[350px] h-[350px] glow-orb-pink rounded-full blur-[100px] pointer-events-none opacity-15 animate-pulse-slow" />

      {/* Spotlight Effect */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_-10%,rgba(99,102,241,0.08),transparent_80%)] pointer-events-none" />

      {/* Grid Pattern overlay */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#1e1b4b08_1px,transparent_1px),linear-gradient(to_bottom,#1e1b4b08_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_80%,transparent_100%)] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex-grow flex flex-col lg:flex-row items-center justify-center gap-12 py-12 relative z-10">
        ...
        >
          {/* Availability Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.02] border border-white/10 backdrop-blur-md mb-6 shadow-md">
          ...
          <h1 className="font-display font-extrabold text-4xl sm:text-5xl md:text-6xl tracking-tight text-white mb-4 leading-tight">
            ...
            <span className="text-gradient-purple font-black filter drop-shadow-[0_0_15px_rgba(139,92,246,0.25)]">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-8">
            <button
              ...
              className="flex items-center justify-center gap-2.5 w-full sm:w-auto px-8 py-3.5 rounded-xl font-bold bg-indigo-600 border border-indigo-500/20 text-white cursor-pointer shadow-[0_0_20px_rgba(99,102,241,0.35)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2.5 w-full sm:w-auto px-6 py-3.5 rounded-xl font-bold bg-white/[0.02] border border-white/10 text-white cursor-pointer hover:bg-white/[0.08] hover:border-purple-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
            >
          ...
          <div className="flex items-center gap-4.5">
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="w-11 h-11 rounded-xl bg-white/[0.01] border border-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:border-white/20 hover:scale-108 hover:shadow-[0_0_15px_rgba(255,255,255,0.05)] transition-all duration-300"
              aria-label="GitHub"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="w-11 h-11 rounded-xl bg-white/[0.01] border border-white/5 flex items-center justify-center text-slate-400 hover:text-indigo-400 hover:border-indigo-500/20 hover:scale-108 hover:shadow-[0_0_15px_rgba(99,102,241,0.15)] transition-all duration-300"
              aria-label="LinkedIn"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="w-11 h-11 rounded-xl bg-white/[0.01] border border-white/5 flex items-center justify-center text-slate-400 hover:text-pink-400 hover:border-pink-500/20 hover:scale-108 hover:shadow-[0_0_15px_rgba(236,72,153,0.15)] transition-all duration-300"
            ...
            <div className="relative">
              <button 
                onClick={copyDiscord}
                className="w-11 h-11 rounded-xl bg-white/[0.01] border border-white/5 flex items-center justify-center text-slate-400 hover:text-indigo-400 hover:border-indigo-500/20 hover:scale-108 hover:shadow-[0_0_15px_rgba(99,102,241,0.15)] transition-all duration-300 cursor-pointer"
        ...
        >
          ...
          <div className="relative w-full max-w-[420px] aspect-square rounded-3xl glass-card border border-white/[0.06] p-6 shadow-2xl flex flex-col justify-between overflow-hidden">
            {/* Inner glows */}
            <div className="absolute top-0 right-0 w-48 h-48 bg-purple-500/5 rounded-full blur-[50px] pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-indigo-500/5 rounded-full blur-[50px] pointer-events-none" />
            ...
            <div className="relative mt-6 flex justify-end">
              <div className="relative w-14 h-14 rounded-2xl bg-gradient-to-tr from-blue-500 to-purple-600 flex items-center justify-center font-bold text-white text-lg shadow-[0_0_20px_rgba(139,92,246,0.35)]">
                HK
          ...
          >
            <span className="w-2.5 h-2.5 rounded-full bg-[#000000] border border-white/20 filter drop-shadow-[0_0_4px_#ffffff]" />
            Next.js
          </motion.div>
          ...
          >
            <span className="w-2.5 h-2.5 rounded-full bg-[#3178c6] filter drop-shadow-[0_0_4px_#3178c6]" />
            TypeScript
          </motion.div>
        </motion.div>
      </div>
