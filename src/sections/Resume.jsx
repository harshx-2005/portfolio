...
export default function Resume() {
  ...
  return (
    <section id="resume" className="relative py-28 overflow-hidden bg-[#030014]">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          {/* Left Column: Academics and credentials info */}
          ...
          {/* Right Column: Certifications & ATS score visualizer */}
          <motion.div className="flex-1 flex flex-col gap-8" variants={itemVariants}>
            ...
            {/* Recruiter ATS matching system simulator dashboard */}
            <div className="glass-card p-8 rounded-3xl border border-white/[0.04] bg-white/[0.01] flex flex-col sm:flex-row items-center justify-between gap-6 hover:border-purple-500/25 transition-all duration-300">
              ...
              <div className="flex-grow select-none">
                ...
                <p className="text-xs text-slate-400 leading-relaxed text-center sm:text-left">
                  This portfolio incorporates structural keywords targeted directly by technical screeners (MERN stack, Django backend architecture, Exotel trunks, software quality assurance).
                </p>
                <div className="flex flex-wrap gap-1.5 mt-3 justify-center sm:justify-start">
                  {["React", "Django", "Node", "QA", "MySQL", "Jira", "Socket.io", "Cloudinary"].map((k) => (
        ...
        >
          <a
            ...
            className="flex items-center gap-3 px-10 py-4 rounded-xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white cursor-pointer shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:shadow-[0_0_30px_rgba(139,92,246,0.6)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
          >
